/* Monaco Editor loader for MediaWiki. Copyright 2017 The Little Moe New LLC */
...
/* 用法
 * 在用户页 JavaScript 里插入 mw.loader.load('https://zh.moegirl.org/User:Imbushuo/MonacoEditor.js?action=raw&ctype=text/javascript'); 即可。
 * Usage:
